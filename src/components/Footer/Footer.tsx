        ...
        <div className="row">
          <div className="col-md-6 py-5">
            ...
            <div className="socials">
              <span className="pe-2">
                <img loading="lazy" data-aos="fade-up" src="http://d9hhrg4mnvzow.cloudfront.net/unbouncepages.com/coffeera/17600a29-facebook-app-symbol_100p00p000000000000028.png" alt="Facebook" />
              </span>
              <span className="pe-2">
                <img loading="lazy" data-aos="fade-up" src="http://d9hhrg4mnvzow.cloudfront.net/unbouncepages.com/coffeera/7b85bd99-twitter2_100p00p000000000000028.png" alt="Twitter" />
              </span>
              <span className="pe-2">
                <img loading="lazy" data-aos="fade-up" src="http://d9hhrg4mnvzow.cloudfront.net/unbouncepages.com/coffeera/21dbf2cd-linkedin2_100p00p000000000000028.png" alt="Linkedin" />
              </span>
            </div>
          </div>
